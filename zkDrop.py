...
class MyFrame4 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 575,750 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        gbSizer1.Add( ( 0, 25 ), wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 3 ), wx.EXPAND, 5 )
        ...
        self.m_staticText5 = wx.StaticText( sbSizer5.GetStaticBox(), wx.ID_ANY, u"Choose Secret", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        gbSizer1.Add( self.m_button1, wx.GBPosition( 7, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
        ...
        gbSizer1.Add( sbSizer6, wx.GBPosition( 9, 1 ), wx.GBSpan( 4, 3 ), wx.EXPAND, 5 )
